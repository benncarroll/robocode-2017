/*
			   ...
			   ___/\\\\\\\\\\\\\\\__/\\\\\\\\\\\\\\\____/\\\\\\\\\_________/\\\\\\\\\_____/\\\_____________
			   ___\/\\\///////////__\/\\\///////////___/\\\///////\\\_____/\\\\\\\\\\\\\__\/\\\_____________
			   ____\/\\\_____________\/\\\_____________\/\\\_____\/\\\____/\\\/////////\\\_\/\\\_____________
			   _____\/\\\\\\\\\\\_____\/\\\\\\\\\\\_____\/\\\\\\\\\\\/____\/\\\_______\/\\\_\/\\\_____________
			   ______\/\\\///////______\/\\\///////______\/\\\//////\\\____\/\\\\\\\\\\\\\\\_\/\\\_____________
			   _______\/\\\_____________\/\\\_____________\/\\\____\//\\\___\/\\\/////////\\\_\/\\\_____________
			   ________\/\\\_____________\/\\\_____________\/\\\_____\//\\\__\/\\\_______\/\\\_\/\\\_____________
			   _________\/\\\_____________\/\\\\\\\\\\\\\\\_\/\\\______\//\\\_\/\\\_______\/\\\_\/\\\\\\\\\\\\\\\_
			   __________\///______________\///////////////__\///________\///__\///________\///__\///////////////__
...
public class Feral extends AdvancedRobot {
    ...
    public void smartMove() {
        ...
        if (getDistanceRemaining() == 0) {
            moveDirection *= -1;
            setAhead(185 * moveDirection * ((randDouble() / 2) + 0.75));
        }
    ...
    public void smartFire() {
        ...
        while (++deltaTime * (20 - (3 * power)) < Point2D.Double.distance(getX(), getY(), pX, pY)) {
            ...
            pX = Math.max(Math.min(pX, getBattleFieldWidth() - 18.0 D), 18.0 D);
            pY = Math.max(Math.min(pY, getBattleFieldHeight() - 18.0 D), 18.0 D);
        }
